...
async def handle_update_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await bot_update_sender.send_message(
        chat_id=CHAT_ID_GROUP_UPDATE, 
...
async def main():
    ...
    while True:
        await asyncio.sleep(3600) # Program akan diam di sini dan bot tetap aktif di background
